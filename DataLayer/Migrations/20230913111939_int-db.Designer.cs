...
namespace DataLayer.Migrations
{
    ...
    [Migration("20230913111939_int-db")]
    partial class intdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.Appointment.Appointment", b =>
                {
                    b.Property<int>("AppoimtmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AppoimtmentId"));
            ...
            modelBuilder.Entity("DataLayer.Entities.Appointment.Timing", b =>
                {
                    ...
                    b.Property<int?>("AppointmentAppoimtmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppointmentAppoimtmentId");
            ...
            modelBuilder.Entity("DataLayer.Entities.Appointment.Timing", b =>
                {
                    b.HasOne("DataLayer.Entities.Appointment.Appointment", "Appointment")
                        .WithMany("Timings")
                        .HasForeignKey("AppointmentAppoimtmentId");
